...
public class MenueAnlegen extends VerticalLayout implements View,
	...
	private Label ueberschrift2 = new Label(
			"<pre><b><font size='5' face=\"Arial, Helvetica, Tahoma, Verdana, sans-serif\">Menue �ndern</font><b></pre>",
			Label.CONTENT_XHTML);
...
//Value Changelistener fuer das Hauptgericht, sobald sich das feld veraendert wird der merkerh auf x gesetzt
	...
	//Diese Funktion wird angesprochen, wenn man ein Menue ansehen oder �ndern moechte, es wir ein Menue
...
private void aendern() {
	...
	//wenn der merker auf x gesetzt ist, das hei�t die Fussnoten ahben sich geaendert
