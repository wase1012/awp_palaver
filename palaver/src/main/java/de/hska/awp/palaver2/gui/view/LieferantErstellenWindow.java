...
public class LieferantErstellenWindow extends VerticalLayout implements View
{
	...
	private TextField			strasse = new TextField("StaßŸe");
	...
	public LieferantErstellenWindow()
	{
		super();
		this.setSizeFull();
		this.setMargin(true);
