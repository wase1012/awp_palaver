...
public class MitarbeiterSuche extends VerticalLayout  implements View{
	...
	private TextField			passwort = new TextField("Passwort");
	...
	private TextField			nameRollen = new TextField("Name");
	...
	public MitarbeiterSuche() throws ConnectException, DAOException, SQLException {
		...
		links.addComponent(eintrittsdatum);
		links.addComponent(austrittsdatum);
		...
		rollen.addItemClickListener(new ItemClickListener() {	
			...
			public void itemClick(ItemClickEvent event) {
				if(event.isDoubleClick()){
					...
					rollen.setCaption("Rollen bearbeiten");
...
//							rollenBean.setMitarbeiter(mitarbeiter);
//							
//							try {
...
//					rollen.setMitarbeiter(mitarbeiter);
//					try {
...
//			try {
////				mitarbeiter = Mitarbeiterverwaltung.getInstance().getLastMitarbeiter();
//			} catch (ConnectException | DAOException | SQLException e) {
...
//			}
		...
		try {
//			container = new BeanItemContainer<Rollen>(Rollen.class, Rollenverwaltung.getInstance().getRollenpartnerByMitarbeiter(mitarbeiter));
//			rollen.setContainerDataSource(container);
			rollen.setVisibleColumns(new Object[] {"name", "vorname", "email", "eintrittsdatum", "austrittsdatum"});
